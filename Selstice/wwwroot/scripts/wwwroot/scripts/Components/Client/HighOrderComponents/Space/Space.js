...
var Space = (function (_super) {
    ...
    Space.prototype.render = function () {
        return (React.createElement("div", { className: "space-container" }, React.createElement(SpaceBackground_1.default, null), React.createElement(NavigationIcons_1.NavigationIcons, null), React.createElement(CompanyMotto_1.CompanyMotto, null)));
    };
    return Space;
}(React.Component));
exports.Space = Space;
